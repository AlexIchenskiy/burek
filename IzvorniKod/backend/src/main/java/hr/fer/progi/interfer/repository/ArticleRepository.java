...
public interface ArticleRepository extends JpaRepository<Article, Long> {
    ...
    @Query("update Article a set a.title = ?2, a.content = ?3, a.tags = ?4, a.published = ?5, a.category = ?6, a.moderated = ?7 where a.id = ?1" )
    void updateArticle(Long id, String title, String content, String tags, Boolean published, Category category, boolean moderated);
